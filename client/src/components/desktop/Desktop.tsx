...
import {
  ...
  getWindow,
  openWindow,
} from "../../core/window/windowManager";
...
export const Desktop: React.FC = () => {
          ...
          content = (
            <div style={contentStyle}>
              ...
              >
                ...
                >
                  This command would execute in a full implementation. The
                  window system is fully functional—you can drag, resize, and
                  close this window.
                </p>
              </div>
            </div>
          ...
          content = (
            <div style={contentStyle}>
              ...
              >
                ...
                >
                  In a full implementation, this would show the actual file
                  contents.
                </p>
              </div>
            </div>
  ...
  return (
    <>
      ...
      <div ref={desktopRef} className="desktop" onClick={handleDesktopClick}>
